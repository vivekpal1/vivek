...
export default function HomePage() {
	...
	const description = `I am an ${age} year old Web Developer from India. I love to build things and solve problems. I am currently working as a backend developer.`;
